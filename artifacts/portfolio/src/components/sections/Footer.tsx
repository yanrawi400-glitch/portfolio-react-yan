    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-end">
          ...
          <div>
            <div className="mono text-primary mb-6">03. GET IN TOUCH</div>
          ...
          <div className="flex flex-col md:items-end space-y-4 mono text-sm text-muted-foreground">
            ...
            <a href="#" className="hover:text-foreground transition-colors" data-testid="link-twitter">Twitter / X</a>
            ...
            <div className="mt-12 pt-8 md:text-right border-t border-border w-full md:w-auto md:min-w-[200px]">
              &copy; {new Date().getFullYear()} WORKSHOP<br/>
              ALL RIGHTS RESERVED.
            </div>
          </div>
